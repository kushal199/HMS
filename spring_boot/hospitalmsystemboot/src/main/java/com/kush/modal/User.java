...
public User(int doctor_id, String firstname, String lastname, String password, String dob, int department_id,
		String address, String email, String active, String username) {
	super();
